...
public class VacancyKafkaProviderImpl
        extends KafkaResponsePublisher<VacancyParseResponsePayload>
        implements KafkaResponseProvider<VacancyParseResponsePayload> {
