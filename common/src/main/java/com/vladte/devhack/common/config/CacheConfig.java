...
public class CacheConfig {
    ...
    /**
     * Cache manager for medium-term caching (1 hour).
     * Used for moderately stable data.
     */
    @Bean
    ...
    /**
     * Cache manager for long-term caching (24 hours).
     * Used for stable data that changes infrequently.
     */
    @Bean
