...
import com.vladte.devhack.domain.config.TestConfig;
import com.vladte.devhack.domain.service.files.CvStorageService;
import com.vladte.devhack.domain.service.files.impl.CvStorageServiceImpl;
...
public class CvStorageServiceTest extends BaseServiceTest {
    ...
    public void testDownloadUserCv_Success() throws Exception {
        ...
        // Mock MinIO client behavior: return a mock GetObjectResponse (subclass of InputStream)
        io.minio.GetObjectResponse mockedResponse = mock(io.minio.GetObjectResponse.class);
